...
Let's first have a look at these files. Open a terminal window, navigate to the `fastq/` directory which contains them, and print out the first eight lines.

```
cd ~/fastq/
head -n 8 SRR3156163_1.fastq.gz
```
